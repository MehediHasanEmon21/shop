  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.coupons') }}" class="nav-link">All Coupon</a></li>
          <li class="nav-item"><a href="{{ route('admin.newsletter') }}" class="nav-link">Newslatetter</a></li>
        </ul>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{ route('admin.password.change') }}"><i class="icon ion-ios-person-outline"></i> Change Password</a></li>
