			  ...
			  <div class="col-lg-12"  style="border: 1px solid grey; padding: 20px;">
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center">Your Order Details</div> <br>
					      ...
					      <div>
							 <ul class="list-group">
							 	<li class="list-group-item">Payment Type:  {{ $track->payment_type }}</li>
							 	<li class="list-group-item">Transection ID:  {{ $track->payment_id }}</li>
							 	<li class="list-group-item">Balance  ID:  {{ $track->blnc_transection }}</li>
							    <li class="list-group-item">Subtotal: {{ $track->subtotal }} $</li>
							 	<li class="list-group-item">Shipping: {{ $track->shipping }} $</li>
							 	<li class="list-group-item">Total: {{ $track->total }} $</li>
							 	<li class="list-group-item">Month: {{ $track->month }}</li>
							 	<li class="list-group-item">Date: {{ $track->date }}</li>
							 </ul>
					     </div>
					 </div>
			  </div>
