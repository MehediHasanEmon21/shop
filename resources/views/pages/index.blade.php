                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                @foreach($hot_deals as $hot_deal)
                                    <div class="owl-item deals_item">
                                        <div class="deals_image"><img src="{{URL::to($hot_deal->image_one)}}" style="width: 310px; height: 310px;" alt=""></div>
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                ...
                                                <div class="product_extras">
                                                    ...
                                                    <button id="{{ $feature_product->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal"  onclick="productview(this.id)">Add to Cart</button>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                ...
                                                @endif
                                                <div class="product_name"><div><a href="product.html">{{$tp->product_name}}</a></div></div>
                                                <div class="product_extras">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                ...
                                                @endif
                                                <div class="product_name"><div><a href="product.html">{{$bp->product_name}}</a></div></div>
                                                <div class="product_extras">
                                        ...
                                        @if($key == 0)
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{URL::to($pro->image_one)}}" alt=""></div>
                                                    <div class="product_content">
                                    ...
                                    <div class="arrivals_slider slider">
                                        ...
                                        @if($key == 1)
                                            ...
                                            <div class="arrivals_slider_item">
                                                <div class="border_active"></div>
                                                <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{URL::to($pro->image_one)}}" style="width: 115px; height: 81px;" alt=""></div>
                                                    <div class="product_content">
                                                        <div class="product_price">${{$pro->selling_price}}</div>
                                                        <div class="product_name"><div><a href="product.html">{{$pro->product_name}}</a></div></div>
                                                        <div class="product_extras">
                        ...
                        <div class="owl-carousel owl-theme trends_slider">
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ URL::to($bg->image_one)}}" style="width: 212px; height: 132px;" alt=""></div>
                                    <div class="trends_content">
                                        <div class="trends_category"><a href="#">{{$bg->category_name}}</a></div>
                                        <div class="trends_info clearfix">
                                            <div class="trends_name"><a href="product.html">{{$bg->product_name}}</a></div>
