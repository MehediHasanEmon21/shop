		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="{{URL::to($product->image_one)}}"><img src="{{URL::to($product->image_one)}}" alt=""></li>
						<li data-image="{{URL::to($product->image_two)}}"><img src="{{URL::to($product->image_two)}}" alt=""></li>
						<li data-image="{{URL::to($product->image_three)}}"><img src="{{URL::to($product->image_three)}}" alt=""></li>
					</ul>
				</div>
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_text"><p>{!! substr($product->product_details, 0, $length = 500) !!}...</p></div>
